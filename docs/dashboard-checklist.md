# Dashboard Checklist for fuckyou.site / fuckyou-site
...
- Authorized domains: include fuckyou.site and www.fuckyou.site if used.
- Firestore: use app-scoped rules under apps/fuckyou-site.
- Storage: do not initialize unless billing/storage is separately approved.

## Google
- Submit https://fuckyou.site/sitemap.xml in Search Console.
